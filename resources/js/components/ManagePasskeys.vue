    ...
    <div v-if="canManagePasskeys" class="space-y-6">
        ...
        <div class="border-border overflow-hidden rounded-lg border">
            ...
            <div v-else class="p-8 text-center">
                <div class="bg-muted mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl">
                    <KeyRound class="text-muted-foreground h-7 w-7" />
                </div>
                <p class="font-medium">No passkeys yet</p>
                <p class="text-muted-foreground mt-1 text-sm">Add a passkey to sign in without a password</p>
            </div>
        </div>
